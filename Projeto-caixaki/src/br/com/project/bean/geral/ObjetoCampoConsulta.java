...
public class ObjetoCampoConsulta implements Serializable, Comparator<ObjetoCampoConsulta>{
	...
	/**
	 * Compara as variáveis 'principal' e ordena do menor para o maior
	 */
	@Override
	...
	/**
	 * Somente com o campoBanco, pois o resto pode ter caso em que se repete, fazendo com que dê erros na aplicação
	 */
